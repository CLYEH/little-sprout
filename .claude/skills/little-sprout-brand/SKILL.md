...
4. **角托三段規則**：四角托＝這是一張沖印品（只有家人的照片；現稿四顆 175 處維持現狀）；對角兩顆＝App icon（≤60pt）與 LS-177 起新畫的沖印品（Hero／Empty Print；既有四顆是否統一另票對帳，LS-96 `6d433e65`）；零角托＝不是沖印品（表單、邀請碼卡——會過期的東西不是收藏品）。角托一律壓過紙緣 `corner-out` 5pt。
