...
4. **角托三段規則**：四角托＝大幅面主視覺的沖印品（只有家人的照片）；對角兩顆＝其餘沖印品的預設（Hero／Empty Print、`cmp/Card Diary`、`cmp/Profile Print`、App icon，LS-177 對帳）；零角托＝不是沖印品（表單、邀請碼卡——會過期的東西不是收藏品）。角托一律壓過紙緣 `corner-out` 5pt。
