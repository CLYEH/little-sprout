...
- 淺墨版兩主題通用一份素材，**不另出深色資產**（`mengya-diary-crayon-v3-dark.png` 已於 R7 刪除；R10 起字標坐在 `$print-paper` 紙上，對比 18.2:1／15.3:1——量的是 v3 蠟筆素材最深像素≈#000 對 `$print-paper`，非 `$print-ink` 的 14.92／12.55）。
