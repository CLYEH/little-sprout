...
| 段 | 角托 | 誰 |
|---|---|---|
| ① 四角托＝大幅面主視覺的沖印品 | 4 | 使用者會收藏、會再看第二次的東西。全 app 只有**家人的照片**，且四顆只留給整幅相紙是畫面主體的大幅面：01／01b／01c／01-iPad／04／04-iPad／A11y-04／07a 範例沖印品 |
| ② 對角兩顆＝其餘沖印品的預設 | 2 對角 | 全稿慣例（LS-177 VR R3 MN-2 對帳，稿為準回修本檔）：Hero Print `zzXNT`（200×155）、Empty Print `K1yE6j`（120×120）、`cmp/Card Diary`、`cmp/Profile Print`、App icon 實機尺寸全用對角兩顆；對角保留「被裱住」的剪影，且對角正好是窗光最強與最弱的兩端。不是「縮到 ≤60pt 才減成兩顆」——尺寸夠大也預設兩顆，四顆要回①的理由 |
