...
#
# 用法：handoff-evidence-check.sh <handoff.md> [--repo <dir>] [--ref <sha>] [--rubric <path>] [--require-selfcheck]
...
[ $# -ge 1 ] || { echo "✗ handoff-evidence-check：用法 handoff-evidence-check.sh <handoff.md> [--repo <dir>] [--ref <sha>] [--rubric <path>] [--require-selfcheck]" >&2; exit 2; }
