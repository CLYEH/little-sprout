...
reset; expect 0 '㉓ dead-code-sweeper 正文含禁派 fork 句 → 印「正文含」（總數 77 條）' 'dead-code-sweeper.md：正文含「禁派 fork」' '正文必含字樣 77 條）'
...
reset; expect 0 '㉕ merge-reviewer 正文含 ubuntu ≥10 次句 → 印「正文含」（總數 77 條）' 'merge-reviewer.md：正文含「shell 自測在 ubuntu:24.04 通道跑 ≥10 次」' '正文必含字樣 77 條）'
...
reset; expect 0 '㉖ merge-reviewer 正文含兩句 → 印「正文含」（總數 77 條）' 'merge-reviewer.md：正文含「UITest mutation 重放要看失敗點／時間軸是否隨 mutation 改變」' '正文必含字樣 77 條）'
...
reset; expect 0 '㉘ ios-dev 正文含「實作新畫面必逐條對 Notes「畫面級屬性」並在 handoff 勾選」→ 印「正文含」（總數 77 條）' 'ios-dev.md：正文含「實作新畫面必逐條對 Notes「畫面級屬性」並在 handoff 勾選」' '正文必含字樣 77 條）'
...
reset; expect 0 '㉛ 六份正文含 mcp__linear__* 備援句 → 印「正文含」（總數 77 條）' 'ios-dev.md：正文含「並在 handoff 註明走備援」' '正文必含字樣 77 條）'
...
reset; expect 0 '㉜ ui-designer／visual-reviewer 正文含 instance 覆寫子節點句 → 印「正文含」（總數 77 條）' 'ui-designer.md：正文含「instance 內覆寫的子節點不可直接」' 'visual-reviewer.md：正文含「instance 內覆寫的子節點不可直接」'
...
#      mutant 下負樣本變綠 ----
reset; expect 0 '㊲ merge-reviewer 正文含 rubric 引用句 → 印「正文含」（總數 77 條）' 'merge-reviewer.md：正文含「四維度檢查項的單一來源是 `docs/REVIEW-RUBRIC.md`」' '正文必含字樣 77 條）'
...
reset; expect 0 '㊶ ios-dev 正文含自檢段標題句 → 印「正文含」（總數 77 條）' 'ios-dev.md：正文含「## 自檢（依 docs/REVIEW-RUBRIC.md）」' '正文必含字樣 77 條）'
...
reset; expect 0 '㊷ merge-reviewer 正文含自檢抽驗句 → 印「正文含」（總數 77 條）' 'merge-reviewer.md：正文含「自檢已宣告通過的項只抽驗、不重寫」' '正文必含字樣 77 條）'
