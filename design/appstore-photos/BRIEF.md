...
1. **比例／可裁切性**（機械）：`sips -g pixelWidth -g pixelHeight <file>` 讀出的寬高比需落在 1.70–1.90 之間，或裁切後可落在此區間且裁切後仍達 §2 最小像素門檻（真正下限 ≥1079×594.5px，建議 ≥1200×661px 留裁切安全邊界；不再重複列出 2160×1190 這個已被 VR R2 MJ-C 判定為重複計算 2 倍的數字，見 §2）；比例落在此區間之外的候選直接淘汰，不進入人工複審。
