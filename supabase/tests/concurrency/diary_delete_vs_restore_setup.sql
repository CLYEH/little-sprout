...
insert into public.profiles (id, display_name) values
  ('a2000000-0000-4000-8000-000000000001', '軟刪還原競態家 owner'),
  ('a3000000-0000-4000-8000-000000000001', '軟刪還原競態家 作者');

-- created_by 由 add_creator_as_owner trigger 寫成 owner
insert into public.families (id, name, created_by) values
  ('f7000000-0000-4000-8000-000000000001', '軟刪還原競態家', 'a2000000-0000-4000-8000-000000000001');

insert into public.family_members (family_id, user_id, role) values
  ('f7000000-0000-4000-8000-000000000001', 'a3000000-0000-4000-8000-000000000001', 'member');
...
insert into public.diaries (id, family_id, author_id, body, entry_date) values
  ('57000000-0000-4000-8000-000000000001', 'f7000000-0000-4000-8000-000000000001',
   'a3000000-0000-4000-8000-000000000001', '原始內容', current_date);
