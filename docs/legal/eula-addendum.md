...
| 版本 | 生效日期 | 摘要 |
|---|---|---|
| v0.1 | 2026-09-03（草稿，未生效） | 初版（草稿） |
| 1.0.0 | 2026-09-12 | 使用者核可，正式生效 |
...
1. 本 App 由 CLYEH（下稱「授權人」）提供。您對本 App 的使用，適用 Apple 公司之「授權應用程式使用者授權合約」（Licensed Application End User License Agreement，網址 https://www.apple.com/legal/internet-services/itunes/dev/stdeula/ ，下稱「Apple 標準 EULA」）之全部條款，該等條款以引用方式納入本合約；另適用下列附加條款。
...
3. 任何使用者皆可在 App 內檢舉內容，或寄信至 support@littlesprout.xyz 檢舉。授權人承諾於收到檢舉後 24 小時內採取行動，包括移除內容及對違規者停權。使用者亦可在 App 內封鎖其他成員；家庭 Owner 可移除其家庭內的任何內容與成員。
